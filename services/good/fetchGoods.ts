...
/** 获取商品列表 */
function mockFetchGoodsList(): Promise<Goods[]> {
  return delay().then(() => mockGoods);
}

/** 获取商品列表 */
export function fetchGoodsList(pageIndex: number = 1, pageSize: number = 20): Promise<Goods[]> {
