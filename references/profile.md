...
我的选课里有了自塾时间管理这门课，但是全部课程里的自塾时间管理

组方舟 和 方舟详情 这两个页面字太小了，字要放大一倍。

你调整字体大小后，底部菜单栏的字体都变小了，而且无法点击了。快给我恢复底部菜单栏到原样。

组方舟这个页面，如果用户已经在方舟中，就不要显示“加入方舟”这个按钮了。

“学习单”这个页面下，“其他在学”这四个字改为“当前在学”。里面的在学课程信息要丰富一些，需包含课程名称、章节名称、截止日期这三个信息。

“学习单”这个页面下，章节名称、截止日期这两个信息和我的选课列表里一致就行，请补上。